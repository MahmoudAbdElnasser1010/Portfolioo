...
export const projects = [
  {
    ...
    ...nimbus,
    slides: projectSlides('project-1'),
  },
  {
    slug: 'project-2',
    order: 2,
    ...
    ...fathom,
    slides: projectSlides('project-2'),
  },
  {
    slug: 'project-3',
    order: 3,
    ...
    ...solace,
    slides: projectSlides('project-3'),
  },
  {
    slug: 'project-4',
    order: 4,
    ...
    ...halo,
    slides: projectSlides('project-4'),
  },
  {
    slug: 'project-5',
    order: 5,
    ...
    ...nimbus,
    slides: projectSlides('project-5'),
  },
  {
    slug: 'project-6',
    order: 6,
    ...
    ...fathom,
    slides: projectSlides('project-6'),
  },
  {
    slug: 'project-7',
    order: 7,
    ...
    ...solace,
    slides: projectSlides('project-7'),
  },
  {
    slug: 'project-8',
    order: 8,
    ...
    ...halo,
    slides: projectSlides('project-8'),
  },
];
...
// Per-project slider images. Each project has its OWN folder of images at
// /public/assets/projects/<slug>/. Replace the placeholder files there with
// your real screens (keep the screen-1..N names), or change `count` / pass an
// explicit `slides` array on the project to control how many show.
export function projectSlides(slug, count = 10) {
  return Array.from({ length: count }, (_, i) => `/assets/projects/${slug}/screen-${i + 1}.svg`);
}
