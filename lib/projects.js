...
const nimbus = {
  category: 'SaaS · Analytics · Design System',
  title: 'Nimbus Analytics — a real-time dashboard for growth teams.',
  sub: "A ground-up redesign of Nimbus's core analytics product, paired with a new design system and a 3x faster data pipeline.",
  info: [
    { k: 'Role', v: 'Lead Product Designer' },
    { k: 'Timeline', v: 'Jan 2024 – Jun 2024 (6 months)' },
    { k: 'Tools', v: 'Figma, React, D3.js' },
    { k: 'Live Site', v: 'nimbus-analytics.co', href: '#' },
  ],
  overview: [
    "Nimbus's original dashboard had grown organically over three years, and it showed — inconsistent components, slow chart rendering, and a navigation model that only made sense to the team that built it.",
    'I was brought on to lead a full redesign: rethink the information architecture, build a proper design system, and work directly with engineering to ship it in production-ready React components.',
  ],
  challenge: {
    intro: 'The core challenge was reducing time-to-insight for users staring at dense, high-frequency data without dumbing the product down for power users who lived in it all day.',
    list: [
      'Legacy UI had 40+ one-off components with no shared source of truth.',
      'Chart rendering slowed to a crawl past 10k data points.',
      'New users took 3+ sessions to find their most-used reports.',
    ],
  },
  approach: {
    ...
    list: [
      'Built a token-based design system shared between Figma and the React codebase.',
      'Redesigned the report navigation around saved views and search instead of nested menus.',
      'Partnered with engineering to move heavy charts to a canvas-based renderer.',
    ],
  },
  results: {
...
const fathom = {
  ...
  approach: {
    ...
    list: [
      'Cut onboarding from 14 screens to 6 with progressive disclosure.',
      'Introduced a customizable home screen with quick actions for freezing cards and setting limits.',
      'Designed a budgeting layer that auto-categorizes spend but stays fully editable.',
    ],
  },
  results: {
...
const solace = {
  ...
  approach: {
    ...
    list: [
      'Combined shipping, payment, and review into one scroll-based checkout page.',
      'Added a sticky add-to-cart bar with real-time stock and shipping estimates.',
      'Shipped a Webflow component library so campaigns launched in days, not weeks.',
    ],
  },
  results: {
...
const halo = {
  ...
  approach: {
    ...
    list: [
      'Defined core tokens for color, type, spacing, and motion.',
      'Built a shared component library in Storybook, wired into the product codebase.',
      'Created reusable deck and one-pager templates for the whole team.',
    ],
  },
  results: {
