...
// UX process steps shown in the "Process" section of every project detail
// page. Add or remove entries here to change the number of steps — the
// detail page numbers and renders however many you list.
const uxProcess = [
  { title: 'Research', desc: 'Stakeholder interviews, competitive audits, and user research to frame the real problem.' },
  { title: 'Define', desc: 'Synthesize findings into clear problem statements, user flows, and success metrics.' },
  { title: 'Ideate', desc: 'Explore low-fidelity concepts and shape the information architecture before visuals.' },
  { title: 'Prototype', desc: 'Turn the strongest direction into high-fidelity, interactive prototypes.' },
  { title: 'Test & Ship', desc: 'Validate with real users, iterate, and hand production-ready design to engineering.' },
];
